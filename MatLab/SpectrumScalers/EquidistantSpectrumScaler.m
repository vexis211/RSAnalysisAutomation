classdef EquidistantSpectrumScaler < SpectrumScalerInterface
    ...
    methods
        ...
        function scaledSpectrum = Scale(obj, spectrum)
            ...
            spectrumCount=size(spectrum.Data,2);
            newData=zeros(length(newWaveNumbers),spectrumCount);
            scaleMethodChar = lower(char(obj.ScaleMethod));
            for i=1:spectrumCount
                newData(:,i) = interp1(spectrum.WaveNumbers, spectrum.Data, newWaveNumbers, scaleMethodChar);
            end            
